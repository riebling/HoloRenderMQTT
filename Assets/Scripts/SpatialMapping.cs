...
public class SpatialMapping : MonoBehaviour {
    ...
    [Tooltip("The material to use when rendering Spatial Mapping (room mesh) data.")]
    public Material DrawMaterial;

    [Tooltip("If true, the Spatial Mapping (room mesh) data will be rendered.")]
    ...
    void OnSelect()
    {
        // although this gets called when AirTap gesture message is sent upstream
        // from GazeGestureManager, the handler is now in our ancestor 'World' object's
        // WallCommands script
    }
}